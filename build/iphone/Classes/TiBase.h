...
// in simulator we redefine to format for AcrySofTv Developer console
...
{\
	NSString * exceptionName = [@"org.acrysoftv." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.acrysoftv";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIAcrySofTvNativeItemNone = -1, 
	UIAcrySofTvNativeItemSpinner = -2,
	UIAcrySofTvNativeItemProgressBar = -3,
	
	UIAcrySofTvNativeItemSlider = -4,
	UIAcrySofTvNativeItemSwitch = -5,
	UIAcrySofTvNativeItemMultiButton = -6,
	UIAcrySofTvNativeItemSegmented = -7,
	
	UIAcrySofTvNativeItemTextView = -8,
	UIAcrySofTvNativeItemTextField = -9,
	UIAcrySofTvNativeItemSearchBar = -10,
	
	UIAcrySofTvNativeItemPicker = -11,
	UIAcrySofTvNativeItemDatePicker = -12,
	
	UIAcrySofTvNativeItemInfoLight = -13,
	UIAcrySofTvNativeItemInfoDark = -14,
	
	UIAcrySofTvNativeItemDisclosure = -15,
	
	UIAcrySofTvNativeItemContactAdd = -16
};
