...
@interface AcrySofTvObject : KrollCoverageObject {
#else
@interface AcrySofTvObject : KrollObject {
#endif
@private
...
extern NSString * AcrySofTv$ModuleRequireFormat;
