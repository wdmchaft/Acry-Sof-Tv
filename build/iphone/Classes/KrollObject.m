 ...
 * Copyright (c) 2009-2011 by AcrySofTv, Inc. All Rights Reserved.
...
//@interface AcrySofTvObject : NSObject
//@end

@interface AcrySofTvObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AcrySofTvObject class]])
		{
			for (NSString *key in [[(AcrySofTvObject*)o modules] allKeys])
			{
